...
//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
form = new Form("IEU aplicaci\u00F3n m\u00F3vil", new Item[]{getStringItem()});//GEN-BEGIN:|14-getter|1|14-postInit
...
//GEN-END:|16-getter|0|16-preInit
            // write pre-init user code here
stringItem = new StringItem("Desarrollo de software", "Mi primera aplicacion Movil JME");//GEN-LINE:|16-getter|1|16-postInit
            // write post-init user code here
