...
//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
form = new Form("Bienvenido a Programacion movil", new Item[]{getStringItem(), getImageItem()});//GEN-BEGIN:|14-getter|1|14-postInit
...
//GEN-END:|16-getter|0|16-preInit
            // write pre-init user code here
stringItem = new StringItem("Hello IEU k017", "Hello, World!");//GEN-LINE:|16-getter|1|16-postInit
            // write post-init user code here
...
//GEN-END:|22-getter|0|22-preInit
 // write pre-init user code here
imageItem = new ImageItem("", getImage(), ImageItem.LAYOUT_DEFAULT, "<Missing Image>");//GEN-LINE:|22-getter|1|22-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: image ">//GEN-BEGIN:|23-getter|0|23-preInit
    /**
...
try {//GEN-BEGIN:|23-getter|1|23-@java.io.IOException
                image = Image.createImage("/ieu-logo.png");
            } catch (java.io.IOException e) {//GEN-END:|23-getter|1|23-@java.io.IOException
    e.printStackTrace();}//GEN-LINE:|23-getter|2|23-postInit
 // write post-init user code here
